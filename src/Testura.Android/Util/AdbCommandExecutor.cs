...
namespace Testura.Android.Util
{
    ...
    public class AdbCommandExecutor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdbCommandExecutor"/> class.
        /// </summary>
        /// <param name="serial">Serial number of device</param>
        /// <param name="adbPath">Path to adb.exe</param>
        public AdbCommandExecutor(string serial = null, string adbPath = null)
        {
            _serial = serial;
            _adbPath = adbPath;
        }
        ...
        public string ExecuteAdbCommand(params string[] arguments)
        {
            ...
            DeviceLogger.Log($"Sending adb command: {string.Join(" ", allArguments)}", DeviceLogger.LogLevel.Info);
            ...
            try
            {
                    ...
                    o => o.Timeout(TimeSpan.FromMinutes(1))))
                {
                    ...
                    if (!command.Result.Success)
                    {
                        ...
                        DeviceLogger.Log(message, DeviceLogger.LogLevel.Error);
        ...
        public Command StartAdbProcess(params string[] arguments)
        {
            ...
            DeviceLogger.Log($"Starting adb process with shell: {string.Join(" ", allArguments)}", DeviceLogger.LogLevel.Info);
        ...
        public Command StartAdbProcessWithoutShell(params string[] arguments)
        {
            ...
            DeviceLogger.Log($"Starting adb process without shell: {string.Join(" ", allArguments)}", DeviceLogger.LogLevel.Info);
