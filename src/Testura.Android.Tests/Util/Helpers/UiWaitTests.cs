...
namespace Testura.Android.Tests.Util.Helpers
{
    ...
    public class UiWaitTests
    {
        ...
        {
            var uiObjectOne = _testHelper.CreateUiObject(new[] {Where.Class("test")}, 0);
            var uiObjectTwo = _testHelper.CreateUiObject(new[] {Where.ResourceId("test")}, 2000);
        ...
        {
            var uiObject = _testHelper.CreateUiObject(new[] {Where.Class("hej")}, 0, true);
        ...
        {
            var uiObjectOne = _testHelper.CreateUiObject(new[] {Where.Class("test")}, 0);
            var uiObjectTwo = _testHelper.CreateUiObject(new[] {Where.ResourceId("test")}, 500, true);
            var foundObject = UiWait.ForAny(new Func<TimeSpan, bool>[] { uiObjectOne.IsVisible, uiObjectTwo.IsHidden}, TimeSpan.FromSeconds(10));
            Assert.AreEqual(uiObjectOne, foundObject);
            Thread.Sleep(1000);
        }
        ...
        {
            var uiObjectOne = _testHelper.CreateUiObject(new[] {Where.Class("test")}, 500);
            var uiObjectTwo = _testHelper.CreateUiObject(new[] {Where.ResourceId("test")}, 500);
        ...
        {
            var uiObjectOne = _testHelper.CreateUiObject(new[] {Where.Class("test")}, 500, true);
            var uiObjectTwo = _testHelper.CreateUiObject(new[] {Where.ResourceId("test")}, 500, true);
